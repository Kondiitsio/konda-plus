...
function kp_recipe_summary_render_cb($atts, $content, $block) {
    ...
    ob_start();
    ?>
    <div class="wp-block-konda-plus-recipe-summary">
    <i class="bi bi-alarm"></i>
    <div class="recipe-columns-2">
        <div class="recipe-metadata">
        <div class="recipe-title">
            <?php _e('Prep Time', 'konda-plus'); ?>
        </div>
