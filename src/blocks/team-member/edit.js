import { 
    ...
    BlockControls, MediaReplaceFlow
  } from '@wordpress/block-editor';
  import { __ } from '@wordpress/i18n';
  import { 
    PanelBody, TextareaControl, Spinner, ToolbarButton,
    Tooltip, Icon, TextControl, Button,
    ...
    return (
        ...
        <InspectorControls>
          <PanelBody title={__('Settings', 'konda-plus')}>
            {imgPreview && !isBlobURL(imgPreview) && (
              <TextareaControl 
              label={__('Alt Attribute', 'konda-plus')}
              value={imgAlt}
        ...
        <div {...blockProps}>
          <div className="author-meta">
            ...
            <p>
              <RichText 
                placeholder={__('Name', 'konda-plus')}
                tagName="strong"
                onChange={name => setAttributes({name})}
                value={name}
              />
              <RichText 
                placeholder={__('Title', 'konda-plus')}
                tagName="span"
          ...
          <div className="member-bio">
            <RichText 
              placeholder={__('Member bio', 'konda-plus')}
              tagName="p"
          ...
          <div className="social-links">
              ...
              { isSelected && (
                <Tooltip text={__("Add Social Media Handle", "konda-plus")}>
                  <a
                    href="#"
                    onClick={(event) => {
                      event.preventDefault();
